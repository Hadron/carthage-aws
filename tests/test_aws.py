...
async def test_attach_volume(carthage_layout):
    ...
    try:
        ...
        instance.injector.add_provider(
            InjectionKey("aws_availability_zone"), instance.machine.mob.placement["AvailabilityZone"]
        )
    ...
    try:
        ...
        with TestTiming(1500):
            await subtest_controller(
                request,
                instance.machine,
                ["--carthage-config=/carthage_aws/config.yml", "/carthage_aws/tests/inner_image_builder.py"],
